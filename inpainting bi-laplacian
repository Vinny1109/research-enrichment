...
image_orig = io.imread(r"C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research enrichment\inpainting\laplacian\bi-laplacian\sbi_nomor50.png")
# image_orig = data.astronaut()[0:200, 0:200]

# Create mask with three defect regions: left, middle, right respectively
mask = np.zeros(image_orig.shape[:-1])
mask[20:130, 50:155] = 1

# Defect image over the same region in each color channel
# image_defect = io.imread(r"C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research enrichment\inpainting\nomor50.png")
...
io.imsave(r'C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research enrichment\inpainting\laplacian\bi-laplacian\sbi_nomor50_inp.png', sparse_img_uint8)
...
io.imsave(r'C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research enrichment\inpainting\laplacian\bi-laplacian\sbi_nomor50_mask.png', mask)


ax[2].set_title('Defected image')
ax[2].imshow(image_defect)
# image_defect = (image_defect * 255).astype(np.uint8)
io.imsave(r'C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research enrichment\inpainting\laplacian\bi-laplacian\sbi_nomor50_defect.png', image_defect)
