...
def number_file(path):
    # path: c:\user\.....\cv2-telea\defect\p1-nomor1_defect.png
...
def base_path(path):
    # path: c:\user\.....\cv2-telea\defect\p1-nomor1_defect.png
    # mundur 1 dir, c:\....\cv2-telea\defect
    filebase =  os.path.dirname(path)   
    print("filebase:", filebase) 
    
    # mundur 1 dir, c:\....\cv2-telea
...
def process_file(path):
    ...
    # hasil C:\Users......\cv2-telea\mask\p1-nomor1_mask.png
    ...
    start_time = time.time()
    inp = cv2.inpaint(damaged_img, mask, 1, cv2.INPAINT_TELEA)
 
    fileinp = os.path.join(base_path(path), 'inp', number_file(path) + '_inp.png')
    print("fileinp:", fileinp)
    # hasil C:\Users......\cv2-telea\inp\p1-nomor1_inp.png
    ...
    # hasil C:\Users\.......\cv2-telea\ori\p1-nomor1_ori.png
...
def main():
    file_onepath = r'C:\Users\vinny\OneDrive - Bina Nusantara\Documents\Research-enrichment\inpainting\cv2-telea\defect\p1-nomor1_defect.png'
    folder_path = 'C:\\Users\\vinny\\OneDrive - Bina Nusantara\\Documents\\Research-enrichment\\inpainting\\cv2-telea\\defect'
